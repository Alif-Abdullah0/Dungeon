...
if 'text' in data:
    if name == "Comic":
        print(tagger(html,'body','"Well, uh, right this way sir!" He hands you a key, and says its for the doorway. "Have fun in there!" His voice cracks as he says those two sentences. <a href="boss.py?name=Comic"> Enter through the doorway </a>'))
    else:
